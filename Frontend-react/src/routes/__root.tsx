...
if (typeof window !== "undefined" && !import.meta.env.VITE_CLERK_PUBLISHABLE_KEY) {
  console.warn("⚠️ Clerk publishable key is missing. Authentication features will not function correctly. Please set VITE_CLERK_PUBLISHABLE_KEY in .env.local.");
}
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Modern Hospital Pvt. Limited" },
      { name: "description", content: "portfolio website for modern hospital pvt. limited" },
